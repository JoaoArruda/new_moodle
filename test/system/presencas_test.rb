...
class PresencasTest < ApplicationSystemTestCase
  ...
  test "creating a Presenca" do
    ...
    fill_in "Aluno", with: @presenca.aluno
    fill_in "Belongs to", with: @presenca.belongs_to
    fill_in "Curso", with: @presenca.curso_id
    fill_in "Data", with: @presenca.data
    fill_in "Disciplina", with: @presenca.disciplina
